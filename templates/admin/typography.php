    ...
    ?>
            ...
            <tr valign="top">
                <td class="forminp forminp-<?php echo sanitize_title( $option['type'] ) ?>[size]"  style="width:20%;">
                  ...
                  <input type="number" name="<?php echo esc_attr( $option['id'] );?>[size]" min="1" value="<?php echo $value['size'];?>" style="width: 60px;margin-left: 10px;">
                </td>
                ...
                <td class="forminp forminp-<?php echo sanitize_title( $option['type'] ) ?>[transform]" style="width:20%;">
                ...
                <td class="forminp forminp-<?php echo sanitize_title( $option['type'] ) ?>[color]" style="width:20%;">
                    ...
                    <input type="text" name="<?php echo esc_attr( $option['id'] );?>[color]"  class="colorpick" style="" value="<?php echo $value['color'];?>">
                </td>
