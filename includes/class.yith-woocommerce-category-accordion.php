...
if( ! class_exists( 'YITH_WC_Category_Accordion' ) ){
    ...
    */
        ...
        /**register YITH WooCommerce Category Accordion widget
         * @author YITHEMES
         * @since 1.0.0
         * @use widgets_init
         */
        ...
        public function enqueue_style_script(){
            ...
            wp_register_script( 'ywcca_accordion', YWCCA_ASSETS_URL .'js/ywcca_accordion.js', array('jquery'), YWCCA_VERSION, true );
